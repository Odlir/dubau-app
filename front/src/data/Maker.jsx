        ...
        },
        {
            ...
            cell: (selector) =>
                <div className={'w-10 h-10 image-fit zoom-in -ml-5'}>
                    <img src={env.URL + selector.maker_NameImage} className={'tooltip rounded-full'}
                         width={60} onClick={(e) => handleOnClickModalImage(selector.maker_NameImage,selector.maker_Name,selector.maker_Description)}
                    />
                </div>
        },
        {
        ...
        },
        {
            ...
            cell: (selector) =>
                <div className="flex justify-center items-center">
                    <button className="flex items-center mr-3" onClick={(e) => actionEdit(selector.maker_ID)}>
                        <Lucide icon="Edit3" className="w-4 h-4 mr-1 text-primary"/>{" "}
                    </button>
                    <button className="flex items-center mr-3" onClick={(e) => actionDelete(selector.maker_ID)}>
