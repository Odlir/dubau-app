...
function Index() {
    ...
    const actionEdit = async (waytopay_ID) => {
        ...
        const response = await axios.get(
            `${endpoint}?waytopay_ID=${waytopay_ID}`
        );
    ...
    const handleOnClickSearch = async (page) => {
        ...
        const endpoint = `${env.apiURL}listWaytoPay`;
        const response = await axios.get(
            `${endpoint}?page=${page_}&per_page=${perPage}&waytopay_Name=${waytopay_Name}&waytopay_CreationDate=${waytopay_CreationDate}`
        );
        setData(response.data.data);
        setPage_(response.data.page);
        setTotalRows(response.data.total);
