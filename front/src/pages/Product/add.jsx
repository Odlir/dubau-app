...
function Add({
    ...
    const optionsProductServiceType = product_service_type_Container.map(
        (obj) => ({
    ...
    if (statusDinamic === 0) {
        defaultSelectedOptionsStatusDinamic = [optionsStatusDinamic[0]];
    }
    if (statusDinamic === 1) {
        defaultSelectedOptionsStatusDinamic = [optionsStatusDinamic[1]];
    }
    const defaultSelectedOptionsFamily = familyContainer.map((obj) =>
    ...
    const defaultSelectedOptionsMarker = makerContainer.map((obj) =>
        maker === obj.maker_ID
            ? {
                  value: obj.maker_ID,
                  label: obj.maker_Name,
    ...
    const defaultSelectedOptionsLine = lineContainer.map((obj) =>
        line === obj.line_ID
            ? {
                  value: obj.line_ID,
                  label: obj.line_Name,
    ...
    const defaultSelectedOptionsUnitMeasure = unit_of_measurement_Container.map(
        (obj) =>
            unitMeasure === obj.unitmeasure_ID
                ? {
                      value: obj.unitmeasure_ID,
                      label: obj.unitmeasure_Description,
                  }
    ...
    const defaultSelectedOptionsProductServiceType =
        product_service_type_Container.map((obj) =>
            productServiceType === obj.product_service_type_id
                ? {
                      value: obj.product_service_type_id,
                      label: obj.name,
                  }
    ...
    const defaultSelectedOptionsBrand = brandContainer.map((obj) =>
        brand === obj.brand_ID
            ? {
                  value: obj.brand_ID,
                  label: obj.brand_Name,
    ...
    const [selectedOptionsFamily, setSelectedOptionsFamily] = useState(
        defaultSelectedOptionsFamily
    );
    const [selectedOptionsMaker, setSelectedOptionsMaker] = useState(
        defaultSelectedOptionsMarker
    );
    const [selectedOptionsLine, setSelectedOptionsLine] = useState(
        defaultSelectedOptionsLine
    );
    const [selectedOptionsUnitMeasure, setSelectedOptionsUnitMeasure] =
        useState(defaultSelectedOptionsUnitMeasure);
    const [
        selectedOptionsProductServiceType,
        setSelectedOptionsProductServiceType,
    ] = useState(defaultSelectedOptionsProductServiceType);
    const [selectedOptionsBrand, setSelectedOptionsBrand] = useState(
        defaultSelectedOptionsBrand
    );
    const [selectedOptionsStatusDinamic, setSelectedOptionsStatusDinamic] =
        useState(defaultSelectedOptionsStatusDinamic);
                    ...
                    <div className=" w-6/12">
                        <div className="border w-full border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                            ...
                            <div className="mt-5">
                                ...
                                <div className="form-inproduct items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div className="form-inproduct items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                    ...
                                    <div className="w-full mt-3 xl:mt-0 flex-1">
                                        <Input
                                            ...
                                            dataId="emailll"
                                            className="form-control"
                                            dataPlaceholder="Este Articulo es exclusivo para ...."
                                ...
                                <div className="mt-3">
                                    ...
                                    <div className="dropdown">
                                        <Select
                                            ...
                                            value={selectedOptionsUnitMeasure}
                                ...
                                <div className="mt-3">
                                    ...
                                    <div className="dropdown">
                                        <Select
                                            ...
                                            onChange={
                                                handleChangeProductServiceType
                                            }
                                            className="w-full"
                                        />
                                    </div>
                            ...
                            <div className="form-inproduct items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div className="w-full mt-3 xl:mt-0 flex-1">
                                    <Input
                                        ...
                                        dataId="email"
                                        className="form-control"
                                        dataPlaceholder="0000000"
                                        dataValue={internal_code}
