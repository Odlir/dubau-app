                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input
                                                ...
                                                className="form-control"
                                                dataPlaceholder="Name Proveedor"
                                                dataValue={
                                                    person_LastNameMaternal
                                                }
                                                dataOnchange={
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input
                                                ...
                                                className="form-control"
                                                dataPlaceholder="Esta Proveedor es exclusivo para ...."
                                ...
                                <div className="mt-5 w-3/6 ">
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input
                                                dataType="text"
                                                dataName="staff3_StartDate"
                                                dataId="staff3_StartDate"
                                                className="form-control"
                                                dataPlaceholder="Name Proveedor"
                                                dataValue={staff3_StartDate}
                                                dataOnchange={
                                                    setStaff3_StartDate
                                                }
                                            />
                                ...
                                <div className="mt-5 w-3/6 ">
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input
                                                dataType="text"
                                                dataName="staff3_finalDate"
                                                dataId="staff3_finalDate"
                                                className="form-control"
                                                dataPlaceholder="Esta Proveedor es exclusivo para ...."
                                                dataValue={staff3_finalDate}
                                                dataOnchange={
                                                    setStaff3_finalDate
                                                }
                                            />
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input
                                                dataType="text"
                                                dataName="staff3_ContractNumber"
                                                dataId="staff3_ContractNumber"
                                                className="form-control"
                                                dataPlaceholder="Esta Proveedor es exclusivo para ...."
                                                dataValue={
                                                    staff3_ContractNumber
