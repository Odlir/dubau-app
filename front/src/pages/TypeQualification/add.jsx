                    ...
                    <div className=" w-6/12">
                        <div className="border w-full border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                            <div
                                ...
                                <Lucide icon="ChevronDown" className="w-4 h-4 mr-2"/> Tipo de Calificacion
                                Info
                            </div>
                            <div className="mt-5">
                                <div
                                    className="form-intypequalification items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                    <div className="form-label xl:w-64 xl:!mr-10">
                                        <div className="text-left">
                                            <div className="flex items-center">
                                                <div className="font-medium">Nombre Tipo de Calificacion</div>
                                                <div
                                    ...
                                    <div className="w-full mt-3 xl:mt-0 flex-1">
                                        <Input dataType={'text'} dataName={'email'} dataId={'email'}
                                               ...
                                               dataPlaceholder={'Name Tipo de Calificacion'} dataValue={typequalification_Name}
                                               dataOnchange={setTypeQualification_Name}/>
                                ...
                                <div
                                    ...
                                    <div className="w-full mt-3 xl:mt-0 flex-1">
                                        <Input dataType={'text'} dataName={'emailll'} dataId={'emailll'}
                                               ...
                                               dataValue={typequalification_Description}
                                               dataOnchange={setTypeQualification_Description}/>
                                        <div className="form-help text-right">
                                            Maximum character 0/50
                                        </div>
                                    </div>
