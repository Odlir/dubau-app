...
import columnsDetail from '../../data/InventoryDetail.jsx';
...
function Index() {
    ...
    const handleOnClickCleanDetail = async () => {
        setShowModal(false);
        setLoading(true);
        setProductName('');
        setSelectedOption('');
    ...
    const handleOnClickCancelDetail = async () => {
        setProductName('');
        setSelectedOption('');
        setQuantity('');
        setPrice('');
    ...
    return (
        <div>
            <div className="z-10  ">
                {showModal ? (
                    <>
                        <div className="modal-detail justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 index-absolute outline-none focus:outline-none">
                            <div className="relative w-auto my-6 mx-auto">
                                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0 w-full justify-end">
                                        <button
                                            className="btn btn-danger shadow-md close"
