...
function Add({
    ...
    return (
        <div>
            <h2 className="intro-y text-lg font-medium mt-10">Añadir Sector</h2>
                                ...
                                <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                    ...
                                    <div className="w-full mt-3 xl:mt-0 flex-1">
                                        <Input
                                            ...
                                            dataPlaceholder="Name Sector"
                                            dataValue={commercial_section_Name}
                                            dataOnchange={
                                                setCommercialSection_Name
                                            }
                                        />
                                ...
                                <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                    ...
                                    <div className="w-full mt-3 xl:mt-0 flex-1">
                                        <Input
                                            ...
                                            dataId="emailll"
                                            className="form-control"
                                            dataPlaceholder="Este Sector es exclusivo para ...."
                                            dataValue={
                                                commercial_section_Description
                                            }
                                            dataOnchange={
