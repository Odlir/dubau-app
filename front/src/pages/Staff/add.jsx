                                        ...
                                        <div className="form-label xl:w-64 xl:!mr-10">
                                            <div className="text-left">
                                                <div className="flex items-center">
                                                    <div className="font-medium">Nombre Personal</div>
                                                    <div
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'person_LastNameMaternal'} dataId={'person_LastNameMaternal'} className={'form-control'}
                                                   dataPlaceholder={'Name Personal'} dataValue={person_LastNameMaternal}
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'person_DateBirth'} dataId={'person_DateBirth'} className={'form-control'}
                                                   dataPlaceholder={'Name Personal'} dataValue={person_DateBirth}
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'ubigeous_PlaceBirth'} dataId={'ubigeous_PlaceBirth'} className={'form-control'}
                                                   dataPlaceholder={'Esta Personal es exclusivo para ....'} dataValue={ubigeous_PlaceBirth}
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'numberDocument'} dataId={'numberDocument'} className={'form-control'}
                                                   dataPlaceholder={'Esta Personal es exclusivo para ....'} dataValue={numberDocument}
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'person_Gender'} dataId={'person_Gender'} className={'form-control'}
                                                   dataPlaceholder={'Esta Personal es exclusivo para ....'} dataValue={person_Gender}
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'statusmarital_ID'} dataId={'statusmarital_ID'} className={'form-control'}
                                                   dataPlaceholder={'Esta Personal es exclusivo para ....'} dataValue={statusmarital_ID}
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'nationality_ID'} dataId={'nationality_ID'} className={'form-control'}
                                                   dataPlaceholder={'Esta Personal es exclusivo para ....'} dataValue={nationality_ID}
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'ubigeous_Home'} dataId={'ubigeous_Home'} className={'form-control'}
                                                   dataPlaceholder={'Name Personal'} dataValue={ubigeous_Home}
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'person_Direction'} dataId={'person_Direction'} className={'form-control'}
                                                   dataPlaceholder={'Name Personal'} dataValue={person_Direction}
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'person_Phone'} dataId={'person_Phone'} className={'form-control'}
                                                   dataPlaceholder={'Esta Personal es exclusivo para ....'} dataValue={person_Phone}
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'person_Email'} dataId={'person_Email'} className={'form-control'}
                                                   dataPlaceholder={'Esta Personal es exclusivo para ....'} dataValue={person_Email}
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'person_CellPhone'} dataId={'person_CellPhone'} className={'form-control'}
                                                   dataPlaceholder={'Esta Personal es exclusivo para ....'} dataValue={person_CellPhone}
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'person_WebSite'} dataId={'person_WebSite'} className={'form-control'}
                                                   dataPlaceholder={'Esta Personal es exclusivo para ....'} dataValue={person_WebSite}
                            ...
                            <div className="flex">
                                <div className="mt-5 w-3/6 ">
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'staff_StartDate'} dataId={'staff_StartDate'} className={'form-control'}
                                                   dataPlaceholder={'Name Personal'} dataValue={staff_StartDate}
                                                   dataOnchange={setStaff_StartDate}/>
                                            <div className="form-help text-right">
                                                Maximum character 0/50
                                            </div>
                                        </div>
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'position_ID'} dataId={'position_ID'} className={'form-control'}
                                                   dataPlaceholder={'Name Personal'} dataValue={position_ID}
                                ...
                                <div className="mt-5 w-3/6 ">
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input dataType={'text'} dataName={'staff_ContractNumber'} dataId={'staff_ContractNumber'} className={'form-control'}
                                                   dataPlaceholder={'Esta Personal es exclusivo para ....'} dataValue={staff_ContractNumber}
                                                   dataOnchange={setStaff_ContractNumber}/>
                                            <div className="form-help text-right">
                                                Maximum character 0/50
                                            </div>
                                        </div>
