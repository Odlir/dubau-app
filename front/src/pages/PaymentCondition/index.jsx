...
function Index() {
    ...
    const [payment_condition_Description, setPaymentCondition_Description] =
        useState('');
    const [DescriptionAgain, setDescriptionAgain] = useState('');
    const [payment_condition_CreationDate, setPaymentConditionCreationDate] =
        useState('');
    const [
        payment_condition_ApprovedStatus,
    ...
    const actionEdit = async (payment_condition_ID) => {
        ...
        const response = await axios.get(
            `${endpoint}?payment_condition_ID=${payment_condition_ID}`
        );
        ...
        setPaymentCondition_Description(
            response.data.payment_condition_Description
        );
        setFormType('edit');
    };
    ...
    const handleOnClickUpdate = async (e) => {
        ...
        await axios
            .post(endpoint, {
                payment_condition_ID: dataxPaymentCondition,
                payment_condition_Name,
                payment_condition_Description,
            })
            .then(() => {
    ...
    const handleOnClickSearch = async () => {
        ...
        const endpoint = `${env.apiURL}listPaymentCondition`;
        const response = await axios.get(
            `${endpoint}?page=${page_}&per_page=${perPage}&payment_condition_Name=${payment_condition_Name}&payment_condition_CreationDate=${payment_condition_CreationDate}`
        );
        setData(response.data.data);
        setPage_(response.data.page);
        setTotalRows(response.data.total);
