                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input
                                                ...
                                                className="form-control"
                                                dataPlaceholder="Esta Cliente es exclusivo para ...."
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input
                                                ...
                                                className="form-control"
                                                dataPlaceholder="Name Departamento"
                                ...
                                <div className="mt-5 w-3/6 ">
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input
                                                dataType="text"
                                                dataName="staff2_StartDate"
                                                dataId="staff2_StartDate"
                                                className="form-control"
                                                dataPlaceholder="Name Cliente"
                                                dataValue={staff2_StartDate}
                                                dataOnchange={
                                                    setStaff2_StartDate
                                                }
                                            />
                                ...
                                <div className="mt-5 w-3/6 ">
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input
                                                dataType="text"
                                                dataName="staff2_finalDate"
                                                dataId="staff2_finalDate"
                                                className="form-control"
                                                dataPlaceholder="Esta Cliente es exclusivo para ...."
                                                dataValue={staff2_finalDate}
                                                dataOnchange={
                                                    setStaff2_finalDate
                                                }
                                            />
                                    ...
                                    <div className="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                        ...
                                        <div className="w-full mt-3 xl:mt-0 flex-1">
                                            <Input
                                                dataType="text"
                                                dataName="staff2_ContractNumber"
                                                dataId="staff2_ContractNumber"
                                                className="form-control"
                                                dataPlaceholder="Esta Cliente es exclusivo para ...."
                                                dataValue={
                                                    staff2_ContractNumber
