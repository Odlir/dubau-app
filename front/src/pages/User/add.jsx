...
import {Modal,ModalBody} from "@/components/base-components/index.js";
...
const Index = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const endpoint = `${env.apiURL}verifyUser`;
                 axios.post(endpoint, {USUA_usuario: USUA_usuario, cji_usuario_estadoVerificado: 1})
                ...
                const endpoint = `${env.apiURL}verifyUser`;
                axios.post(endpoint, {USUA_usuario: USUA_usuario, cji_usuario_estadoVerificado: 0})
                    .then(function (response) {
                        fetchUsers(page_);
                    })
                    .catch(error => {
    ...
    const actionDelete = async (USUA_usuario) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios.post(endpoint, {USUA_usuario: USUA_usuario, cji_usuario_estadoID: 0})
                    .then(function (response) {
                        fetchUsers(page_);
                    })
                    .catch(error => {
    ...
    const actionEdit = async (USUA_usuario) => {
        console.log('unico');
    }
