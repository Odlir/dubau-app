                        ...
                        <div className="intro-y box p-5 mt-5">
                            ...
                            <div className="w-52 sm:w-auto mx-auto mt-8">
                                ...
                                <div className="flex items-center mt-4">
                                    ...
                                    <span className="truncate">mayor 50 Years old</span> <span className="font-medium ml-auto">10%</span> 
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-span-12 xl:col-span-4 mt-6">
                        ...
                        <div className="mt-5">
                            <div className="intro-y">
                                <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div className="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src={Profile_cinco}/>
                                    </div>
                                    <div className="ml-4 mr-auto">
                                        <div className="font-medium">Leonardo DiCaprio</div>
                                        <div className="text-slate-500 text-xs mt-0.5">15 August 2022</div>
                                    </div>
                            ...
                            <div className="intro-y">
                                <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div className="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src={Profile_quince}/>
                                    </div>
                                    <div className="ml-4 mr-auto">
                                        <div className="font-medium">Kate Winslet</div>
                                        <div className="text-slate-500 text-xs mt-0.5">25 August 2020</div>
                                    </div>
                                    <div className="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">137 Sales</div>
                                </div>
                            </div>
                            <div className="intro-y">
                                <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div className="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src={Profile_once}/>
                                    </div>
                                    <div className="ml-4 mr-auto">
                                        <div className="font-medium">Hugh Jackman</div>
                                        <div className="text-slate-500 text-xs mt-0.5">10 April 2021</div>
                                    </div>
                                    <div className="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">137 Sales</div>
                                </div>
                            </div>
                            <div className="intro-y">
                                <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div className="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                        <img alt="Midone - HTML Admin Template" src={Profile_ocho}/>
                                    </div>
                                    <div className="ml-4 mr-auto">
                                ...
                                <tbody>
                                        ...
                                        <td className="w-40">
                                            <div className="flex">
                                                <div className="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src={Preview_catorce} title="Uploaded at 15 August 2022"/>
                                                </div>
                                                <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src={Profile_diez} title="Uploaded at 1 January 2021"/>
                                                </div>
                                                <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src={Profile_doce} title="Uploaded at 11 November 2022"/>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr className="intro-x">
                                        <td className="w-40">
                                            <div className="flex">
                                                <div className="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src={Preview_quince} title="Uploaded at 25 August 2020"/>
                                                </div>
                                                <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src={Profile_doce} title="Uploaded at 14 October 2020"/>
                                                </div>
                                                <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src={Preview_catorce} title="Uploaded at 27 November 2021"/>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr className="intro-x">
                                        <td className="w-40">
                                            <div className="flex">
                                                <div className="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src={Profile_cinco} title="Uploaded at 10 April 2021"/>
                                                </div>
                                                <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src={Preview_seis} title="Uploaded at 17 May 2021"/>
                                                </div>
                                                <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src={Preview_seis} title="Uploaded at 11 December 2022"/>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <a href="" className="font-medium whitespace-nowrap">Nike Air Max 270</a> 
                                            <div className="text-slate-500 text-xs whitespace-nowrap mt-0.5">Sport &amp; Outdoor</div>
                                        </td>
                                    ...
                                    <tr className="intro-x">
                                        <td className="w-40">
                                            <div className="flex">
                                                <div className="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src={Profile_doce} title="Uploaded at 10 September 2020"/>
                                                </div>
                                                <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src={Preview_ocho} title="Uploaded at 9 November 2022"/>
                                                </div>
                                                <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src={Preview_catorce} title="Uploaded at 3 December 2021"/>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                ...
                                <div className="intro-x">
                                    <div className="box px-5 py-3 mb-3 flex items-center zoom-in">
                                        ...
                                        <div className="ml-4 mr-auto">
                                            ...
                                            <div className="text-slate-500 text-xs mt-0.5">20 August 2022</div>
                                        </div>
                            ...
                            <div className="mt-5 relative before:block before:absolute before:w-px before:h-[85%] before:bg-slate-200 before:dark:bg-darkmode-400 before:ml-5 before:mt-5">
                                <div className="intro-x relative flex items-center mb-3">
                                    <div className="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                        <div className="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                            <img alt="Midone - HTML Admin Template" src={Preview_uno}/>
                                        </div>
                                    </div>
                                    ...
                                    <div className="box px-5 py-3 ml-4 flex-1 zoom-in">
                                        ...
                                        <div className="text-slate-500">
                                            ...
                                            <div className="flex mt-2">
                                                <div className="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nike Tanjun">
                                                    <img alt="Midone - HTML Admin Template" className="rounded-md border border-white" src={Preview_catorce}/>
                                                </div>
                                                <div className="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Samsung Galaxy S20 Ultra">
                                                    <img alt="Midone - HTML Admin Template" className="rounded-md border border-white" src={Preview_siete}/>
                                                </div>
                                                <div className="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nike Air Max 270">
                                                    <img alt="Midone - HTML Admin Template" className="rounded-md border border-white" src={Profile_diez}/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="intro-x relative flex items-center mb-3">
                                    <div className="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                        <div className="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                            <img alt="Midone - HTML Admin Template" src={Profile_dos}/>
                                        </div>
                                    </div>
                                    <div className="box px-5 py-3 ml-4 flex-1 zoom-in">
                                        <div className="flex items-center">
                                        ...
                                        <div className="text-slate-500 mt-1">Has changed <a className="text-primary" href="">Dell XPS 13</a> price and description</div>
                                    </div>
                                </div>
                                <div className="intro-x relative flex items-center mb-3">
                                    <div className="before:block before:absolute before:w-20 before:h-px before:bg-slate-200 before:dark:bg-darkmode-400 before:mt-5 before:ml-5">
                                        <div className="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                            <img alt="Midone - HTML Admin Template" src={Profile_tres}/>
                                        </div>
                                    </div>
                                    <div className="box px-5 py-3 ml-4 flex-1 zoom-in">
                                        <div className="flex items-center">
                                        ...
                                        <div className="text-slate-500 mt-1">Has changed <a className="text-primary" href="">Samsung Q90 QLED TV</a> description</div>
                                    </div>
                                </div>
                            </div>
                        </div>
